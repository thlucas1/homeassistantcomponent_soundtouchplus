...
###### [ 1.0.182 ] - 2026/07/21
  ...
  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.277`.

###### [ 1.0.181 ] - 2026/07/21

  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.276`.
...
###### [ 1.0.170 ] - 2026/02/22
  ...
  * Updated `spotifywebapipython` package requirement to `spotifywebapipython>=1.0.263`.
...
###### [ 1.0.124 ] - 2025/06/18
  ...
  * Forgot to push new release to github.
